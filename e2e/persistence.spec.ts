...
test.describe('Persistence & Offline', () => {
    ...
    test('should create a habit, toggle it, and persist everything after reload', async ({ page }) => {
        // 1. Initial Load
        await page.goto('/');
        ...
        await expect(checkButtonsReloaded.first().locator('svg.lucide-check')).toBeVisible();
    });
